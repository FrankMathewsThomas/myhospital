...
$sql=mysqli_query($con,"Update users set fullName='$fname',address='$address',city='$city',dob='$dob',gender='$gender',bloodgrp='$bloodgrp' where id='".$_SESSION['id']."'");
if($sql)
{
...
<p><b>Profile Registered Date: </b><?php echo htmlentities($data['regDate']);?></p>
...
<div class="form-group">
	...
	<input type="date" name="dob" class="form-control" value="<?php echo htmlentities($data['dob']);?>" >
														</div>
...
<div class="form-group">
	...
	<input type="text" name="bloodgrp" class="form-control" value="<?php echo htmlentities($data['bloodgrp']);?>" >
														</div>
