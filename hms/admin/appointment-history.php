...
{
	echo "<label style=\"min-width:120px;color:green; padding: 0.4rem;\">Active</label>";
}
if(($row['userStatus']==0) && ($row['doctorStatus']==1))  
{
	echo "<label style=\"min-width:120px;color:blue; padding: 0.4rem;\">Cancel By Patient</label>";
}
