...
header('location:doc-reset-password.php');
} else {
...
<html lang="en">
	...
	<body class="login">
		...
		<div class="header">
				<div class="wrap">
				<div class="logo">
					<a href="\hospital\index.html" style="font-size: 30px; font-family: 'Trebuchet MS', sans-serif; color: blue;">FEDERAL CARE HOSPITAL</a>
				</div>
				<div class="top-nav">
					<ul>
		...
		<div class="clear"> </div>
			...
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> FD</span>. <span>All rights reserved</span>
					</div>
